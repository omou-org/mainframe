...
class Query(account_schema.Query, course_schema.Query, payment_schema.Query,
            scheduler_schema.Query, search_schema.Query, pricing_schema.Query,
            graphene.ObjectType):
    pass


class Mutation(account_mutations.Mutation, course_mutations.Mutation,
               pricing_mutations.Mutation, scheduler_mutations.Mutation, 
               payment_mutations.Mutation, graphene.ObjectType):
