...
class Query(object):
    ...
    validate_session_schedule = Field(
        ValidateScheduleType, instructor_id=ID(required=True),
        start_time=String(required=True), end_time=String(required=True),
        date=String(required=True),
    )
    validate_course_schedule = Field(
        ValidateScheduleType, instructor_id=ID(required=True),
        start_time=String(required=True), end_time=String(required=True),
        start_date=String(required=True), end_date=String(required=True),
    )
